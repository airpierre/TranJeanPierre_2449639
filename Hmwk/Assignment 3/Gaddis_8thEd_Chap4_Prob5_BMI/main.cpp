...
int main(int argc, char** argv) {
    ...
    //Input values
    cout<<"Insert your weight in pounds, height"            //Ask user to input weight and height to receive BMI
        <<"in inches and receive your BMI number."<<endl;   
    cin>>weight>>height;                                    //Input
    
    //Input Validation
    if (weight<0||height<0) {                               //If user inputs invalid number then display
